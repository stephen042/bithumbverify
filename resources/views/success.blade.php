...
<body>
    <section class="modal hidden" >
        <div style="padding: 0.3rem;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;" >
            <p style="color: #10a30b;font-size: 23px;font-weight:600; padding: 0.3rem;">Verified Resource by Bithumb</p>
        </div>
        <div style="border: 1px solid #DEE2E6; width: 100%;"></div>

        <div style="font-family: Lucida Console, Courier New, monospace;">
            <div class="flex" style="justify-content: center;">
                <img src="assets/home/images/success.png" width="100px" height="100px" alt="user" />
                <!-- <button class="btn-close">⨉</button> -->
            </div>
            <div style="text-align: justify;">
                <!-- <h3>Stay in touch</h3> -->
                <p style="color: rgb(65, 63, 63);font-weight:500;font-size: 18px;margin: 1.5rem;" >
                    The information you entered 
                        @if (session()->has('name'))
                        (<span style="color:#10a30b;">{{session('name')}}</span>)
                        @endif
                     has been verified to be an official Bithumb account or resource. Do not trust any information that is not from an official Bithumb account or resource. Protect the safety of your assets at all times
                </p>
            </div>
            
        </div>
        {{-- a div with 10px length --}}
        <div style="border: 1px solid #DEE2E6; width: 100%;"></div>
